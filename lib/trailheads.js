...
module.exports.getTrailheads = function(req, res, next) {
    ...
    var query = "SELECT id, name, descriptio description, author_id, park_name, ST_AsEWKT(ST_Transform(geom, 4326)) geom FROM trailheads";
...
module.exports.getTrailheadById = function(req, res, next) {
    ...
    var query = "SELECT id, name, descriptio description, author_id, park_name, ST_AsEWKT(ST_Transform(geom, 4326)) geom FROM trailheads WHERE id=$1";
